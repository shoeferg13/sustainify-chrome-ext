...
class Brand:
    ...
    def __init__(self, brand):
        ...
        # citation:
        # https://urldefense.com/v3/__https://software-testing.com/topic/134/how-can-i-run-a-selenium-webdriver-as-a-background-process-in-python/2__;!!DZ3fjg!u32373dQHjmqpiMoma2LIqLwY2RFmlzSi5LDK-KH3DNZ9SodJK2tw0zG9U4Bi4R1$ 
        options = webdriver.ChromeOptions()
        options.add_argument('--headless')
        self.__driver = webdriver.Chrome(ChromeDriverManager().install(),
                                         options=options)
        self.__directory_link = "https://urldefense.com/v3/__https://tinyurl.com/mvznk9mt__;!!DZ3fjg!u32373dQHjmqpiMoma2LIqLwY2RFmlzSi5LDK-KH3DNZ9SodJK2tw0zG9QqNqvkE$ "
    ...
    def get_inclusive_ranges_to_split_paragraphs(self, sentences_list):
        ...
        para_inclusive_ranges.append((start_range, len(sentences_list)-2))
